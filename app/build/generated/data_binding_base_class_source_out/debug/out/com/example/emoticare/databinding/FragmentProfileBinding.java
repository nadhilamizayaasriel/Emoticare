...
public final class FragmentProfileBinding implements ViewBinding {
  ...
  private FragmentProfileBinding(@NonNull ConstraintLayout rootView, @NonNull Button buttonSignOut,
      @NonNull LinearLayout cardProfile, @NonNull ImageButton darkMode,
  ...
  public static FragmentProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentProfileBinding((ConstraintLayout) rootView, buttonSignOut, cardProfile,
          darkMode, imageViewProfile, textViewEmail, textViewName);
    }
